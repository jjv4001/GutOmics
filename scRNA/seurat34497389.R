...
merged.gut<-readRDS("/home/fs01/jjv4001/PMID34497389_iter_1_seurat.rds")

merged.gut <- FindClusters(merged.gut, resolution=0.75)
cells <- structure(c("Mesenchymal", "Epithelial", "Epithelial", "Epithelial", "Epithelial", "Epithelial","Epithelial","Epithelial","Epithelial","Endothelial","Epithelial","Mesenchymal","Epithelial","Epithelial","Immune cells","Neuronal","Epithelial","Epithelial","Epithelial","Mesenchymal","Epithelial","Epithelial","Immune cells","Epithelial","Mesenchymal","Mesenchymal","Mesenchymal","Mesenchymal","RBCs","Mesenchymal","Immune cells","Epithelial","Epithelial","Epithelial"), names=levels(merged.gut))
merged.gut <- RenameIdents(merged.gut, cells)
merged.gut$Cell_Type <- as.character(merged.gut@active.ident)
pdf(paste("PMID34497389_umap_cluster_iter_6.pdf", sep=""))
DimPlot(merged.gut, reduction="umap", label=TRUE)
dev.off()
# clustering analysis
merged.gut<-subset(merged.gut, idents="Epithelial")
saveRDS(merged.gut, file=paste("PMID34497389_integrated_iter_2_seurat.rds", sep=""))
# save Seurat analysis