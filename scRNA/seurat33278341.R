...
# cells <- structure(c("C1", "C2", "C3", "C4", "C5", "C1"), names=levels(seurat))
# seurat <- RenameIdents(seurat, cells)
# seurat$Cell_Type <- as.character(seurat@active.ident)
# pdf(paste(id, "_umap_cluster_iter_1.pdf", sep=""))
